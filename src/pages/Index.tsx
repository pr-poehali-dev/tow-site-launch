...
const Index = () => {
  const services = [
    ...
    {
      icon: "Map",
      title: "Транспортировка по всей РФ",
      description: "Доставка автомобилей в любой регион России"
    }
  ];

  const zones = [
    { name: "Шебекино", time: "15 мин" },
    { name: "Разумное", time: "20 мин" },
    { name: "Белгород", time: "30 мин" },
    { name: "Маслова Пристань", time: "20 мин" },
    { name: "Короча", time: "40 мин" }
  ];
